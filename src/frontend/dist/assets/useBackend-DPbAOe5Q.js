...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, i as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, k as RequestStatusResponseStatus, U as UnknownError, m as RequestStatusDoneNoReplyErrorCode, n as RejectError, o as CertifiedRejectErrorCode, p as UNREACHABLE_ERROR, I as InputError, q as InvalidReadStateRequestErrorCode, s as ReadRequestType, t as Principal, v as IDL, w as MissingCanisterIdErrorCode, H as HttpAgent, x as encode, Q as QueryResponseStatus, y as UncertifiedRejectErrorCode, z as isV3ResponseBody, A as isV2ResponseBody, B as UncertifiedRejectUpdateErrorCode, D as UnexpectedErrorCode, F as decode, G as Subscribable, J as pendingThenable, K as resolveEnabled, N as shallowEqualObjects, O as resolveStaleTime, V as noop, W as environmentManager, X as isValidTimeout, Y as timeUntilStale, Z as timeoutManager, _ as focusManager, $ as fetchState, a0 as replaceData, a1 as notifyManager, a2 as hashKey, a3 as getDefaultState, r as reactExports, a4 as shouldThrowError, a as useQueryClient, a5 as useInternetIdentity, a6 as createActorWithConfig, a7 as Record, a8 as Opt, a9 as Vec, aa as Service, ab as Func, ac as Nat, ad as Text, ae as Bool, af as Variant, ag as Int } from "./index-BXOuU6Ia.js";
...
const PlaceOrderRequest = Record({
  "customerName": Text,
  "paymentMethod": Text,
  "city": Text,
  "address": Text,
...
Service({
  ...
  "addReview": Func(
    [Nat, Text, Nat, Text],
    [Variant({ "ok": Review, "err": Text })],
    []
  ),
  "adminLogin": Func([Text], [Bool], []),
  "deleteCategory": Func([CategoryId], [Bool], []),
  "deleteProduct": Func([ProductId], [Bool], []),
  "getActiveAnnouncement": Func([], [Opt(Announcement)], ["query"]),
  ...
  "getProductSlots": Func([CategoryId], [Vec(Product)], ["query"]),
  "getProductsByCategory": Func(
    [CategoryId],
    [Vec(Product)],
    ["query"]
  ),
  "initializeCategorySlots": Func([CategoryId], [Bool], []),
  "placeOrder": Func([PlaceOrderRequest], [Order], []),
  "setAdminPassword": Func([Text, Text], [Bool], []),
  "setAnnouncement": Func([Text, Bool], [Bool], []),
  "toggleAnnouncement": Func([Bool], [Bool], []),
  "updateCategory": Func(
    [CategoryId, Text, Text, Text, Opt(Text)],
    [Bool],
    []
  ),
  "updateOrderStatus": Func([OrderId, Text], [Bool], []),
  "updateProduct": Func(
    [
      ProductId,
      CategoryId,
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const PlaceOrderRequest2 = IDL2.Record({
    "customerName": IDL2.Text,
    "paymentMethod": IDL2.Text,
    "city": IDL2.Text,
    "address": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "addReview": IDL2.Func(
      ...
      [IDL2.Variant({ "ok": Review2, "err": IDL2.Text })],
      []
    ),
    "adminLogin": IDL2.Func([IDL2.Text], [IDL2.Bool], []),
    "deleteCategory": IDL2.Func([CategoryId2], [IDL2.Bool], []),
    "deleteProduct": IDL2.Func([ProductId2], [IDL2.Bool], []),
    "getActiveAnnouncement": IDL2.Func([], [IDL2.Opt(Announcement2)], ["query"]),
    ...
    "getProductSlots": IDL2.Func([CategoryId2], [IDL2.Vec(Product2)], ["query"]),
    "getProductsByCategory": IDL2.Func(
      [CategoryId2],
      [IDL2.Vec(Product2)],
      ["query"]
    ),
    "initializeCategorySlots": IDL2.Func([CategoryId2], [IDL2.Bool], []),
    "placeOrder": IDL2.Func([PlaceOrderRequest2], [Order2], []),
    "setAdminPassword": IDL2.Func([IDL2.Text, IDL2.Text], [IDL2.Bool], []),
    "setAnnouncement": IDL2.Func([IDL2.Text, IDL2.Bool], [IDL2.Bool], []),
    "toggleAnnouncement": IDL2.Func([IDL2.Bool], [IDL2.Bool], []),
    "updateCategory": IDL2.Func(
      [CategoryId2, IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Opt(IDL2.Text)],
      [IDL2.Bool],
      []
    ),
    "updateOrderStatus": IDL2.Func([OrderId2, IDL2.Text], [IDL2.Bool], []),
...
class Backend {
  ...
  async addProduct(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
    if (this.processError) {
      try {
  ...
  async initializeCategorySlots(arg0) {
    if (this.processError) {
      try {
  ...
  async setAdminPassword(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async setAnnouncement(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async updateProduct(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) {
    if (this.processError) {
      try {
...
function from_candid_Category_n2(_uploadFile, _downloadFile, value) {
...
const retryDelayCritical = (attempt) => Math.min(1e3 * 1.8 ** attempt, 3e4);
function useIsBackendReady() {
...
function useProductSlots(categoryId) {
    ...
    queryFn: async () => {
      ...
      try {
        ...
        if (typeof backendActor.getProductSlots === "function") {
          return await backendActor.getProductSlots(categoryId);
        }
      } catch {
      }
...
function useInitializeCategorySlots() {
  const { actor } = useBackendActor();
...
function useToggleAnnouncement() {
  const { actor } = useBackendActor();
  const qc = useQueryClient();
  return useMutation({
...
function useGetProductReviews(productId) {
  const { actor } = useBackendActor();
  return useQuery({
...
export {
  useCategories as a,
  useGetAnnouncement as b,
  useAllProducts as c,
  useProductsByCategory as d,
  useGetProductReviews as e,
  useAddReview as f,
  usePlaceOrder as g,
  useAdminLogin as h,
  useAllOrders as i,
  useActor as j,
  useSetAnnouncement as k,
  useToggleAnnouncement as l,
  createActor as m,
  useAddCategory as n,
  useUpdateCategory as o,
  useDeleteCategory as p,
  useProductSlots as q,
  useInitializeCategorySlots as r,
  useAddProduct as s,
  useUpdateProduct as t,
  useIsBackendReady as u,
  useDeleteProduct as v,
  useUpdateOrderStatus as w
};
